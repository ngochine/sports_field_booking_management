...
Revision ID: 8ddb1eb6e511
Revises: 
Create Date: 2026-05-18 14:37:26.310182
...
def upgrade():
    ...
    sa.Column('trans_id', sa.String(length=50), nullable=True),
    sa.Column('trans_token', sa.String(length=50), nullable=True),
    sa.Column('return_code', sa.Integer(), nullable=True),
    sa.Column('order_url', sa.String(length=255), nullable=True),
    sa.Column('order_token', sa.String(length=255), nullable=True),
    sa.Column('booking_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['booking_id'], ['booking.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
