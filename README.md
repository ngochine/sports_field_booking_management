...
## Mô tả 
Dự án phục vụ cho bài tập lớn môn Kiểm thử phần mềm, cho phép người dùng xem, đặt/hủy/thanh toán sân thể thao theo khung giờ. Quá trình kiểm thử sẽ theo quy trình từ kiểm thử unit test, integration test, system test đến acceptance test để đảm bảo chất lượng.
